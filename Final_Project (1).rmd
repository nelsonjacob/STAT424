...
Ha: mui != mj, for at least one (i,j)
...
Using Tukey's HSD and an alpha of 0.05, we can see exactly which wood types differ from each other. In this case, the p-values suggest a difference in water absorption for wood 3 and 1, wood 4 and 1, wood 3 and 2, wood 4 and 2, wood 5 and 3, and wood 5 and 4.
